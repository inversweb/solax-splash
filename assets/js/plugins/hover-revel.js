 ...
 */
{
    ...
    class HoverImgFx1 {
        constructor(el) {
            ...
            this.DOM.reveal.className = 'tmp-img-reveal-wrapper';
            this.DOM.reveal.innerHTML = `<div class="tmp-img-reveal-wrapper__inner">
                <div class="tmp-img-reveal-wrapper__img" style="background-image:url(${this.DOM.el.dataset.img ? this.DOM.el.dataset.img: ''})">
                    <div class="tmp-hover-wrapper"> 
                        <h3 class="tmp-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3>
                        <span class="tmp-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span>
                        <p>${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p>
                        <div class="tmp-hover-meta">
                            <span>
            ...
            this.DOM.revealInner = this.DOM.reveal.querySelector('.tmp-img-reveal-wrapper__inner');
            this.DOM.revealInner.style.overflow = 'hidden';
            this.DOM.revealImg = this.DOM.revealInner.querySelector('.tmp-img-reveal-wrapper__img');
    ...
    class HoverImgFx2 {
        constructor(el) {
            ...
            this.DOM.reveal = document.createElement('div');
            this.DOM.reveal.className = 'tmp-img-reveal-wrapper';
            this.DOM.reveal.innerHTML = `<div class="tmp-img-reveal-wrapper__inner"><div class="tmp-img-reveal-wrapper__img" style="background-image:url(${this.DOM.el.dataset.img})"><span class="tmp-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span> <h3 class="tmp-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3><p class="tp-hover-desc">${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p></div></div>`;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealInner = this.DOM.reveal.querySelector('.tmp-img-reveal-wrapper__inner');
            this.DOM.revealInner.style.overflow = 'hidden';
            this.DOM.revealImg = this.DOM.revealInner.querySelector('.tmp-img-reveal-wrapper__img');
    ...
    class HoverImgFx5 {
        constructor(el) {
            ...
            this.DOM.reveal = document.createElement('div');
            this.DOM.reveal.className = 'tmp-img-reveal-wrapper';
            this.DOM.reveal.innerHTML = `<div class="tmp-img-reveal-wrapper__deco"></div><div class="tmp-img-reveal-wrapper__inner"><div class="tmp-img-reveal-wrapper__img" style="background-image:url(${this.DOM.el.dataset.img})"><span class="tmp-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span> <h3 class="tmp-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3><p class="tp-hover-desc">${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p></div></div>`;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealInner = this.DOM.reveal.querySelector('.tmp-img-reveal-wrapper__inner');
            this.DOM.revealInner.style.overflow = 'hidden';
            this.DOM.revealDeco = this.DOM.reveal.querySelector('.tmp-img-reveal-wrapper__deco');
            this.DOM.revealImg = this.DOM.revealInner.querySelector('.tmp-img-reveal-wrapper__img');
            charming(this.DOM.el);
            this.DOM.letters = [...this.DOM.el.querySelectorAll('span')];
            this.initEvents();
    ...
    class HoverImgFx12 {
        constructor(el) {
            ...
            for (let i = 0; i <= this.totalDecos-1; ++i) {
                inner += '<div class="tmp-img-reveal-wrapper__deco"></div>';
            }
            inner += `<div class="tmp-img-reveal-wrapper__inner"><div class="tmp-img-reveal-wrapper__img" style="background-image:url(${this.DOM.el.dataset.img})"><span class="tmp-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span> <h3 class="tmp-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3><p class="tp-hover-desc">${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p></div></div>`
            this.DOM.reveal.innerHTML = inner;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealDecos = [...this.DOM.reveal.querySelectorAll('.tmp-img-reveal-wrapper__deco')];
    ...
    class HoverImgFx13 {
        constructor(el) {
            ...
            for (let i = 0; i <= this.totalImages-1; ++i) {
                inner += `<div class="tmp-img-reveal-wrapper__img" style="position: absolute; background-image:url(${this.DOM.el.dataset.img})"><span class="tmp-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span> <h3 class="tmp-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3><p class="tp-hover-desc">${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p></div>`;
            }
            this.DOM.reveal.innerHTML = inner;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealImgs = [...this.DOM.reveal.querySelectorAll('.tmp-img-reveal-wrapper__img')];
            charming(this.DOM.el);
            this.DOM.letters = [...this.DOM.el.querySelectorAll('span')];
            this.initEvents();
        }
    ...
    class HoverImgFx14 {
        constructor(el) {
            ...
            for (let i = 0, len = imgsArr.length; i <= len-1; ++i ) {
                inner += `<div class="tmp-img-reveal-wrapper__img" style="transform-origin:0% 0%;opacity:0;position:absolute;background-image:url(${imgsArr[i]})"><span class="tmp-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span> <h3 class="tmp-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3><p class="tp-hover-desc">${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p></div>`;
            }
            this.DOM.reveal.innerHTML = inner;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealImgs = [...this.DOM.reveal.querySelectorAll('.tmp-img-reveal-wrapper__img')];
    ...
    class HoverImgFx20 {
        constructor(el) {
            ...
            let inner = '';
            for (let i = 0; i <= this.totalImages-1; ++i) {
                inner += i === this.totalImages-1 ? `<div class="tmp-img-reveal-wrapper__img" style="position: absolute; background-image:url(${this.DOM.el.dataset.img})"><span class="tmp-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span> <h3 class="tmp-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3><p class="tp-hover-desc">${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p></div>` :
                                                    `<div class="tmp-img-reveal-wrapper__img" style="filter: hue-rotate(60deg) saturate(5); position: absolute; background-image:url(${this.DOM.el.dataset.img})"></div>`;
            }
            this.DOM.reveal.innerHTML = inner;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealImgs = [...this.DOM.reveal.querySelectorAll('.tmp-img-reveal-wrapper__img')];
    ...
    class HoverImgFx21 {
        constructor(el) {
            ...
            for (let i = 0; i <= this.totalImages-1; ++i) {
                inner += i === this.totalImages-1 ? `<div class="tmp-img-reveal-wrapper__img" style="position: absolute; background-image:url(${this.DOM.el.dataset.img})"><span class="tmp-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span> <h3 class="tmp-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3><p class="tp-hover-desc">${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p></div>` :
                                                    `<div class="tmp-img-reveal-wrapper__img" style="filter: hue-rotate(90deg) saturate(9); position: absolute; background-image:url(${this.DOM.el.dataset.img})"></div>`;
            }
            this.DOM.reveal.innerHTML = inner;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealImgs = [...this.DOM.reveal.querySelectorAll('.tmp-img-reveal-wrapper__img')];
    ...
    class HoverImgFx22 {
        constructor(el) {
            ...
            this.DOM.reveal = document.createElement('div');
            this.DOM.reveal.className = 'tmp-img-reveal-wrapper';
            this.DOM.reveal.innerHTML = `<div class="tmp-img-reveal-wrapper__img" style="background-image:url(${this.DOM.el.dataset.img})"><span class="tmp-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span> <h3 class="tmp-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3><p class="tp-hover-desc">${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p></div>`;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealImg = this.DOM.reveal.querySelector('.tmp-img-reveal-wrapper__img');
    ...
    [...document.querySelectorAll('[data-fx="pt1"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="pt1"]')].forEach(link => new HoverPTCard1(link));
    [...document.querySelectorAll('[data-fx="1"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="1"]')].forEach(link => new HoverImgFx1(link));
    [...document.querySelectorAll('[data-fx="2"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="2"]')].forEach(link => new HoverImgFx2(link));
    [...document.querySelectorAll('[data-fx="3"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="3"]')].forEach(link => new HoverImgFx3(link));
    [...document.querySelectorAll('[data-fx="4"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="4"]')].forEach(link => new HoverImgFx4(link));
    [...document.querySelectorAll('[data-fx="5"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="5"]')].forEach(link => new HoverImgFx5(link));
    [...document.querySelectorAll('[data-fx="6"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="6"]')].forEach(link => new HoverImgFx6(link));
    [...document.querySelectorAll('[data-fx="7"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="7"]')].forEach(link => new HoverImgFx7(link));
    [...document.querySelectorAll('[data-fx="8"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="8"]')].forEach(link => new HoverImgFx8(link));
    [...document.querySelectorAll('[data-fx="9"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="9"]')].forEach(link => new HoverImgFx9(link));
    [...document.querySelectorAll('[data-fx="10"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="10"]')].forEach(link => new HoverImgFx10(link));
    [...document.querySelectorAll('[data-fx="11"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="11"]')].forEach(link => new HoverImgFx11(link));
    [...document.querySelectorAll('[data-fx="12"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="12"]')].forEach(link => new HoverImgFx12(link));
    [...document.querySelectorAll('[data-fx="13"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="13"]')].forEach(link => new HoverImgFx13(link));
    [...document.querySelectorAll('[data-fx="14"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="14"]')].forEach(link => new HoverImgFx14(link));
    [...document.querySelectorAll('[data-fx="15"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="15"]')].forEach(link => new HoverImgFx15(link));
    [...document.querySelectorAll('[data-fx="16"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="16"]')].forEach(link => new HoverImgFx16(link));
    [...document.querySelectorAll('[data-fx="17"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="17"]')].forEach(link => new HoverImgFx17(link));
    [...document.querySelectorAll('[data-fx="18"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="18"]')].forEach(link => new HoverImgFx18(link));
    [...document.querySelectorAll('[data-fx="19"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="19"]')].forEach(link => new HoverImgFx19(link));
    [...document.querySelectorAll('[data-fx="20"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="20"]')].forEach(link => new HoverImgFx20(link));
    [...document.querySelectorAll('[data-fx="21"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="21"]')].forEach(link => new HoverImgFx21(link));
    [...document.querySelectorAll('[data-fx="22"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="22"]')].forEach(link => new HoverImgFx22(link));
    [...document.querySelectorAll('[data-fx="23"] > .tmp-img-reveal-item, .tmp-img-reveal-item[data-fx="23"]')].forEach(link => new HoverImgFx23(link));
